...
Begin VB.Form frmParam 
   ...
   Begin TabDlg.SSTab TabOptions 
      ...
      Tab(1).Control(0)=   "lstFiltersIn"
      Tab(1).Control(1)=   "lstFiltersOut"
      Tab(1).Control(2)=   "btnDownIn"
      Tab(1).Control(3)=   "btnRemIn"
      Tab(1).Control(4)=   "btnUpIn"
      Tab(1).Control(5)=   "btnAddIn"
      Tab(1).Control(6)=   "btnRemOut"
      Tab(1).Control(7)=   "cmbMapIn"
      Tab(1).Control(8)=   "cmbMapOut"
      Tab(1).Control(9)=   "btnAddOut"
      Tab(1).Control(10)=   "btnDownOut"
      Tab(1).Control(11)=   "btnUpOut"
      Tab(1).Control(12)=   "Line8"
      Tab(1).Control(13)=   "Line7"
      Tab(1).Control(14)=   "Line6"
      Tab(1).Control(15)=   "Line5"
      Tab(1).Control(16)=   "lblMapIn"
      Tab(1).Control(17)=   "lblMapOut"
      Tab(1).Control(18)=   "lblFiltersIn"
      Tab(1).Control(19)=   "lblFiltersOut"
      Tab(1).Control(20)=   "lblFilters"
      Tab(1).Control(21)=   "imgIcon_Filters"
      Tab(1).ControlCount=   22
      TabCaption(2)   =   "Zoom"
      TabPicture(2)   =   "frmParam.frx":047A
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "lblZoom"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "imgIcon_Zoom"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "lblTrashVPHistory"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "btnZoomClear"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "lstZoom"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).ControlCount=   5
      TabCaption(3)   =   "Position"
      TabPicture(3)   =   "frmParam.frx":0496
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "txtPosEY"
      Tab(3).Control(1)=   "txtPosEX"
      Tab(3).Control(2)=   "txtPosSY"
      Tab(3).Control(3)=   "txtPosSX"
      Tab(3).Control(4)=   "fraPos"
      Tab(3).Control(5)=   "lblPosEY"
      Tab(3).Control(6)=   "lblPosEX"
      Tab(3).Control(7)=   "lblPosSY"
      Tab(3).Control(8)=   "lblPosSX"
      Tab(3).Control(9)=   "lblPosition"
      Tab(3).Control(10)=   "imgIcon_Pos"
      Tab(3).ControlCount=   11
      TabCaption(4)   =   "Palette"
      TabPicture(4)   =   "frmParam.frx":04B2
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "fraPalCtrl"
      Tab(4).Control(1)=   "fraPalOptions"
      Tab(4).Control(2)=   "btnPalZoomOut"
      Tab(4).Control(3)=   "btnPalZoomIn"
      Tab(4).Control(4)=   "scrPalImg"
      Tab(4).Control(5)=   "imgPal"
      Tab(4).Control(6)=   "lblPalette"
      Tab(4).Control(7)=   "imgIcon_Palette"
      Tab(4).Control(8)=   "Line4"
      Tab(4).Control(9)=   "Line3"
      Tab(4).ControlCount=   10
      TabCaption(5)   =   "Color Cycling"
      TabPicture(5)   =   "frmParam.frx":04CE
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "UDPASpeed"
      Tab(5).Control(1)=   "fraInterpolatePAnim"
      Tab(5).Control(2)=   "fraNormPAnim"
      Tab(5).Control(3)=   "txtPalSpeed"
      Tab(5).Control(4)=   "btnPalAnim"
      Tab(5).Control(5)=   "lblNorm"
      Tab(5).Control(6)=   "lblAnimation"
      Tab(5).Control(7)=   "lblPalanimSpeed"
      Tab(5).Control(8)=   "imgIcon_Animation"
      Tab(5).ControlCount=   9
      TabCaption(6)   =   "States"
      TabPicture(6)   =   "frmParam.frx":04EA
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "btnSaveStateFile"
      Tab(6).Control(1)=   "btnRemState"
      Tab(6).Control(2)=   "btnSaveState"
      Tab(6).Control(3)=   "lstStates"
      Tab(6).Control(4)=   "Label1"
      Tab(6).Control(5)=   "lblStates"
      Tab(6).Control(6)=   "imgIcon_States"
